    ...
    <div className="flex h-full items-center justify-center bg-background">
      <div className="mx-auto w-full max-w-md space-y-8 px-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="mb-1.5 block text-xs font-medium text-muted-foreground">
              API key (Optional in dev - overrides global key)
            </label>
            <Input
              type="password"
              value={apiKey}
              ...
              placeholder={
                provider === "gemini"
                  ? "AIzaSy... (or leave empty to use built-in)"
                  : provider === "openai"
                    ? "sk-..."
                    : "sk-ant-..."
              }
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 pt-1">
          ...
          <div>
            <label className="mb-1.5 block text-xs font-medium text-muted-foreground">
              {status?.hasUserKey ? "Replace API key" : "API key (Optional in Dev - Custom Key takes Priority)"}
            </label>
            <Input
              type="password"
              value={apiKey}
