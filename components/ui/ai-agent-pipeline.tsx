...
export function EnterpriseAIPipeline({ className = "" }: { className?: string }) {
  ...
  return (
    <div className={`bg-[#090909] border border-white/[0.08] rounded-[14px] overflow-hidden font-sans w-full max-w-[620px] mx-auto shadow-2xl ${className}`}>
      {/* Header */}
      ...
      <div className="w-full overflow-x-auto">
        <svg viewBox="0 0 580 172" className="w-full min-w-[500px] block">
          <defs>
            <marker
              id="ma"
              viewBox="0 0 10 10"
          ...
          <div className="relative flex-1 overflow-hidden h-full">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="font-mono text-[11px] text-white/[0.42] leading-[1.55] absolute inset-0 truncate"
              >
      ...
      {/* Stats Footer */}
      <div className="border-t border-white/[0.06] px-[18px] py-[10px] flex gap-[18px] sm:gap-[22px] items-center flex-wrap">
        <div>
